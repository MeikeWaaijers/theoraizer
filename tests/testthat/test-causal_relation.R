...
test_that("causal_relation() works", {
  ...
  vcr::use_cassette("causal_relation", {
    rel <- CLDassist::causal_relation(topic = "addiction",
                                      variable_list = CLDassist::vars$final_list[1:2])
...
test_that("Invalid topic parameter causes error", {
  testthat::expect_error(CLDassist::causal_relation(topic = 123,
...
test_that("Invalid variable_list parameter causes error", {
  testthat::expect_error(CLDassist::causal_relation(topic = "Climate Change",
