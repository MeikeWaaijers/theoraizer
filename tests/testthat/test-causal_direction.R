...
test_that("causal_direction() works", {
  ...
  vcr::use_cassette("causal_direction", {
    dir <- CLDassist::causal_direction(topic = "addiction",
                                       relation_df = CLDassist::rel$relation_df[1,])
...
test_that("Invalid topic parameter causes error", {
  ...
  testthat::expect_error(CLDassist::causal_direction(topic = 123,
...
test_that("Invalid relation_df parameter causes error", {
  testthat::expect_error(CLDassist::causal_direction(topic = "Climate Change",
