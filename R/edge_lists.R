...
# Description: This data set contains a list of 4 edge lists related to the context of addiction. The data was generated using the "gpt-4o" Large Language Model (LLM).
...
#' edge_lists data
#'
#' This data set contains a list of 4 edge lists related to the context of addiction.
