...
# Description: This data set contains an edge list of causal relationships related to the topic of addiction, together with sources and short explanatory summaries of how each source discusses the corresponding relationship. The data was generated using the "gpt-4.1" Large Language Model (LLM).
...
#' of addiction, enriched with scientific literature and explanatory summaries of how
#' each source discusses the corresponding relationship.
#' The data was generated using the \code{\link{search_literature}} function and the "gpt-4.1" Large Language Model (LLM).
#'
...
#'     }} \cr
#'   \item \code{edge_list_with_lit}: A dataframe containing the original edge
#'   list columns, enriched with literature and summaries:
#'     \describe{
#'     \itemize{
...
#'       \item \code{explanation}: A short explanatory summary of how the identified literature discusses the causal relationship.
#'       \item \code{literature}: One or more citation links returned by the LLM, stored as a semicolon-separated string.
#'     }}
#' }
#' }
#'
